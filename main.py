...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Szybka zamiana pliku zapobiega ucięciu danych podczas odczytu z zewnątrz
        os.replace(TEMP_FILENAME, FILENAME)
        
        # Lepszy wgląd w stan bota - jeśli error_count zbliża się do liczby instrumentów, wiemy, że API nie działa.
        print(f"Zapisano pomyślnie o {timestamp}. Pobrane: {len(data)}, Błędy API/Tickerów: {error_count}")
